...
if __name__ == "__main__":
    ...
    ylabels = [
        (
            ...
            if b_id.split("_")[1] == "3"
                ...
                if b_id.split("_")[1] == "1"
                else ("{}-{}".format(bottle_table[b_id][0]["expr_name"][4:7], 3))
            )
        )
    ...
    ylabels = [
        (
            ...
            else "{}-1{}".format(bottle_table[b_id][0]["expr_name"][4:7], b_id.split("_")[1])
        )
        for b_id in bottle_table.keys()
    ]
    cumul_labels.extend(ylabels)
    ...
    # legend = ax.legend(handles=legend_patches, loc="upper left", fontsize=16)
